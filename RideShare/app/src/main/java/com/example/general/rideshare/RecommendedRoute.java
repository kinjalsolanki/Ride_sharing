...
public class RecommendedRoute extends ActionBarActivity implements View.OnClickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener  {
    ...
    private void getPath()
    {
        ...
        {
            String url = getDirectionsUrl(sLatLng,mLatLng,dLatLng);
    ...
    private class AsyncRecommendRouteWS extends AsyncTask<String, Void, String> {
        @Override
        ...
        protected void onPostExecute(String result) {
            final String[] rr = res.split(",");
            final CharSequence[] items = {rr[0], rr[1], rr[2]};

            builder.setTitle("Select one Area");
            builder.setSingleChoiceItems(items, -1, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int item) {
                    ...
                    if (items[item] == rr[0]) {
                        String location = rr[0];
                        if (location != null && !location.equals("")) {
                            System.out.println("locatttioHADFkJBVCLJBVLJ"+location);
                            new GeocoderTask().execute(location);

                        }
                    } else if (items[item] == rr[1]) {
                        String location = rr[1];
                        if (location != null && !location.equals("")) {
                            System.out.println("locatttioHADFkJBVCLJBVLJ"+location);
                            new GeocoderTask().execute(location);

                        }}
                    else if(items[item]==rr[2])
                    {String location = rr[2];
                        if (location != null && !location.equals("")) {
                            System.out.println("locatttioHADFkJBVCLJBVLJ"+location);
                            new GeocoderTask().execute(location);
    ...
    private String getDirectionsUrl(LatLng origin,LatLng midpt, LatLng dest) {
    ...
    public void onClick(View v) {
        Intent intent = new Intent(RecommendedRoute.this, GetInformation.class);
