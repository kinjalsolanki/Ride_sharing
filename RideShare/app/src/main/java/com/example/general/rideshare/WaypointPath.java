...
public class WaypointPath extends ActionBarActivity implements View.OnClickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener  {

    String uname,approxfare,location;
    ...
    public void onClick(View v) {
        Intent intent = new Intent(WaypointPath.this, GetInformation.class);
