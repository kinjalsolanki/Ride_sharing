 ...
 */
public class GetMyRouteCall
{
    private static String NAMESPACE = "http://tempuri.org/";
    private static String URL = "http://rideshare.somee.com/Service1.asmx";
    private static String SOAP_ACTION = "http://tempuri.org/";
    private static String webMethName="returnMyRoutes";

    public static String getRoute(String uname)
    {
    ...
    public static String getOwnerRoute(String uname)
    {

        String res="";

        SoapObject request = new SoapObject(NAMESPACE, "returnOwnerRoutes");
        PropertyInfo addUser = new PropertyInfo();
        addUser.setName("Uname");
        addUser.setValue(uname);
        addUser.setType(String.class);
